# Langfuse.Client.Model.LfDatasetRun
...
**CreatedAt** | **DateTime** | The date and time when the dataset run was created | 
**UpdatedAt** | **DateTime** | The date and time when the dataset run was last updated | 

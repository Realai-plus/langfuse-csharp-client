...
namespace Langfuse.Client.Api
{
    ...
    public interface IHealthApiSync : IApiAccessor
    {
        ...
        /// <returns>LfHealthResponse</returns>
        ...
        /// </remarks>
        /// <exception cref="Langfuse.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of LfHealthResponse</returns>
        ApiResponse<LfHealthResponse> HealthHealthWithHttpInfo();
    ...
    public interface IHealthApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of LfHealthResponse</returns>
        System.Threading.Tasks.Task<LfHealthResponse> HealthHealthAsync(System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <exception cref="Langfuse.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LfHealthResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<LfHealthResponse>> HealthHealthWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class HealthApi : IDisposable, IHealthApi
    {
        ...
        /// <returns></returns>
        public HealthApi(Langfuse.Client.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public HealthApi(HttpClient client, Langfuse.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public HealthApi(Langfuse.Client.Client.ISynchronousClient client, Langfuse.Client.Client.IAsynchronousClient asyncClient, Langfuse.Client.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="Langfuse.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>LfHealthResponse</returns>
        public LfHealthResponse HealthHealth()
        {
            Langfuse.Client.Client.ApiResponse<LfHealthResponse> localVarResponse = HealthHealthWithHttpInfo();
        ...
        /// <exception cref="Langfuse.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of LfHealthResponse</returns>
        public Langfuse.Client.Client.ApiResponse<LfHealthResponse> HealthHealthWithHttpInfo()
        {
            ...
            var localVarResponse = this.Client.Get<LfHealthResponse>("/api/public/health", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("HealthHealth", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of LfHealthResponse</returns>
        public async System.Threading.Tasks.Task<LfHealthResponse> HealthHealthAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            Langfuse.Client.Client.ApiResponse<LfHealthResponse> localVarResponse = await HealthHealthWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LfHealthResponse)</returns>
        public async System.Threading.Tasks.Task<Langfuse.Client.Client.ApiResponse<LfHealthResponse>> HealthHealthWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<LfHealthResponse>("/api/public/health", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
